...
!
! ------------------------------------------------------------
! powershell to this directory and setup vars with:
!  cmd.exe "/K" '"C:\Program Files (x86)\Intel\oneAPI\setvars.bat" && powershell'
!
! Build the program using the /Qcoarray option as follows:
...
! Computing pi using 600000000 trials across 16 images
! Computed value of pi is 3.1415867, Relative Error: .190E-05
! Elapsed time is 1.12 seconds